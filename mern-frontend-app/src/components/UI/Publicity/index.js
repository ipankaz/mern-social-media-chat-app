      ...
      <div className="publicity-box-0">
        ...
        {publicity.map((element,index)=>(
           ...
           <div className="profile-picture-0">
             <a href="/">
               <img src={ element.user.profilePicture ? generatePublicUrl(element.user.profilePicture.img) : userMale} alt="profile"></img>
             </a>
           </div>
           ...
           <div className="publicity-change-0">
            ...
            <span onClick={()=>handleRemoveUserPublicity(element.user._id)}>Following</span>
            <div className="publicity-icon-0">
              <ion-icon onClick={()=>handleRemoveUserPublicity(element.user._id)} name="person-add-outline"></ion-icon>
            </div>
          </div> : 
            <div className="publicity-work-0">
            <span onClick={()=>handleAddUserPublicity(element.user._id)}>Follow</span>
            <div className="publicity-icon-0">
              <ion-icon onClick={()=>handleAddUserPublicity(element.user._id)} name="person-add-outline"></ion-icon>
            </div>
          </div>
          :
           <div className="publicity-work-0">
